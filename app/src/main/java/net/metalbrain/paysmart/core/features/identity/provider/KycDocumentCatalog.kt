...
private val kycDocumentDatabase: List<KycCountryDocuments> = listOf(
    ...
    KycCountryDocuments(
        ...
        documents = listOf(
            ...
            KycDocumentType(id = "national_id", label = "National ID"),
            KycDocumentType(id = "drivers_license", label = "Driver's license"),
            KycDocumentType(id = "residence_permit", label = "Residence permit", accepted = false),
        ),
    ),
    KycCountryDocuments(
        iso2 = "NL",
    ...
    KycCountryDocuments(
        ...
        documents = listOf(
            ...
            KycDocumentType(id = "national_id", label = "National ID"),
            KycDocumentType(id = "drivers_license", label = "Driver's license"),
            KycDocumentType(id = "residence_card", label = "Residence card", accepted = false),
        ),
    ),
    KycCountryDocuments(
        iso2 = "NO",
    ...
    KycCountryDocuments(
        ...
        documents = listOf(
            KycDocumentType(id = "passport", label = "passport"),
            KycDocumentType(id = "national_id", label = "Emirates ID"),
            KycDocumentType(id = "drivers_license", label = "Driver's license"),
            KycDocumentType(id = "visa", label = "Visa", accepted = false),
        ),
    ),
    KycCountryDocuments(
        ...
        documents = listOf(
            ...
            KycDocumentType(id = "national_id", label = "National ID"),
            KycDocumentType(id = "drivers_license", label = "Driver's license"),
            KycDocumentType(id = "iqama", label = "Residence permit (Iqama)", accepted = false),
        ),
    ),
    KycCountryDocuments(
        iso2 = "IN",
        documents = listOf(
            KycDocumentType(id = "passport", label = "passport"),
            KycDocumentType(id = "national_id", label = "Aadhaar card"),
            KycDocumentType(id = "drivers_license", label = "Driver's license"),
            KycDocumentType(id = "voters", label = "Voter's card"),
            KycDocumentType(id = "pan_card", label = "PAN card", accepted = false),
        ),
    ),
    KycCountryDocuments(
        iso2 = "PL",
    ...
    KycCountryDocuments(
        ...
        documents = listOf(
            KycDocumentType(id = "passport", label = "passport"),
            KycDocumentType(id = "drivers_license", label = "Driver's license"),
            KycDocumentType(id = "national_id", label = "My Number card"),
            KycDocumentType(id = "residence_card", label = "Residence card", accepted = false),
        ),
    ),
)
...
val KycDocumentType.frameShape: CameraFrameShape
    get() = when (id.lowercase(Locale.US)) {
        ...
        "residence_card",
        "iqama",
        "pan_card" -> CameraFrameShape.CARD
...
val KycDocumentType.captureLabel: String
    get() = when (id.lowercase(Locale.US)) {
        ...
        "residence_permit" -> "Residence permit front"
        "residence_card" -> "Residence card front"
        "nin" -> "NIN card front"
        "voters" -> "Voter card front"
        "iqama" -> "Iqama front"
