...
internal enum class TransactionSemantic(
...
internal data class TransactionVisualColors(
    val iconContainer: Color,
    val iconTint: Color,
    val accent: Color
)

internal fun Transaction.semantic(): TransactionSemantic {
...
@Composable
internal fun Transaction.semanticColors(): TransactionVisualColors {
...
internal fun Transaction.formattedAmount(includePrefix: Boolean = false): String {
...
internal fun Transaction.listSubtitle(): String {
    return listOfNotNull(provider, time)
        .joinToString(" • ")
        .ifBlank { time }
}

internal fun Transaction.summaryMetadata(): String? {
