...
internal data class HomeTransactionSearchSnapshot(
...
internal fun observeHomeTransactionSearch(
...
internal fun HomeTransactionProviderFilter.matches(transaction: Transaction): Boolean {
