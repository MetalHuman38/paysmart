...
import net.metalbrain.paysmart.core.features.account.address.remote.HomeAddressPolicyHandler
...
class SecurityRepository @Inject constructor(
    ...
    private fun mapRoomModelToLocal(
        ...
        return currentLocal.copy(
            ...
            biometricsEnabled = currentLocal.biometricsEnabled,
            biometricsEnabledAt = currentLocal.biometricsEnabledAt,
