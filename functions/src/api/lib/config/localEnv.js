...
export function resolveLocalEnvProjectId(env) {
...
export function buildLocalEnvPaths(packageRoot, env) {
...
export function shouldLoadLocalEnv(env) {
...
function isEmulatorRuntime(env) {
    return [
