...
export async function confirmPhoneChangedHandler(req, res) {
    try {
        ...
        if (e instanceof Error &&
            ...
            const statusCode = e.message === "Verified phone number does not match requested phone number" ? 409 : 400;
