...
export async function identityProviderCallbackHandler(req, res) {
    try {
        ...
        const useCase = new SubmitIdentityProviderCallback(identityProvider, securitySettings);
...
//# sourceMappingURL=identityProviderCallback.js.map