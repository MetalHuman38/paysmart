...
describe("PlayIntegrityVerifier", () => {
    it("accepts a valid Play Integrity payload", async () => {
        ...
        const verifier = new PlayIntegrityVerifier(tokenProvider, {
    ...
    it("rejects payload when nonce mismatches", async () => {
        ...
        await expect(verifier.verify("attestation.jwt.token", "nonce-1")).rejects.toThrow("nonce mismatch");
    });
...
//# sourceMappingURL=playIntegrityVerifier.test.js.map