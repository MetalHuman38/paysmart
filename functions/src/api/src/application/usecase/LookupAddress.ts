import { AddressLookupInput, AddressLookupResult } from "./lookupAddress/types/address.js";
...
export class LookupAddress {
  async execute(input: AddressLookupInput): Promise<AddressLookupResult | null> {
