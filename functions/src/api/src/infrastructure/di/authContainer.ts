...
export function authContainer() {
  ...
  const identityUploadRepo = new FirestoreIdentityUploadRepository(
    firestore,
    storageBucket,
    attestationVerifier,
    kmsEnvelopeService,
  ...
  const addMoneyFlutterwaveRepo = new FirestoreAddMoneyFlutterwaveRepository(
    firestore,
