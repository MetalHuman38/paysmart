...
import { googleAddressValidationLookup } from "../../../../../application/usecase/lookupAddress/providers/googleAddressValidation.js";
...
describe.sequential("googleAddressValidationLookup", () => {
  ...
  it("maps a complete premise-level validation to VERIFIED", async () => {
    ...
    const requestInit = (call[1] ?? {}) as { method?: string; body?: unknown };
