...
export async function beforeSignInPolicy(event) {
    const { securitySettingsRepo, auditLogRepo, authService, authSessionRepo } = buildAuthContainer();
    const usecase = new BeforeSignInPolicyUsecase(securitySettingsRepo, auditLogRepo, authService, authSessionRepo);
...
//# sourceMappingURL=beforeSignIn.policy.js.map